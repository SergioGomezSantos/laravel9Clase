...
class CatalogController extends Controller
{
    ...
    {
        return view('videoclub.catalog.index', ['arrayPeliculas' => $this->arrayPeliculas]);
    }

    public function getShow($id = 0)
    {
        return view('videoclub.catalog.show', ['pelicula' => $this->arrayPeliculas[$id]]);
    }

    public function getCreate()
    {
        return view('videoclub.catalog.create');
    }

    public function getEdit($id = 0)
    {
        return view('videoclub.catalog.edit', array('id' => $id));
    }
}
